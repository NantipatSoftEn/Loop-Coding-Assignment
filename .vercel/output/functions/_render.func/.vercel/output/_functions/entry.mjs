...
import { l as levels, g as getEventPrefix, e as ensure404Route, d as default404Instance, D as DEFAULT_404_ROUTE, L as Logger, A as AstroIntegrationLogger, m as manifest } from './chunks/_@astrojs-manifest_Ba04wEzb.mjs';
import { A as AstroError, g as i18nNoLocaleFoundInPath, h as appendForwardSlash, j as joinPaths, k as MiddlewareNoDataOrNextCalled, l as MiddlewareNotAResponse, G as GetStaticPathsRequired, m as InvalidGetStaticPathsReturn, n as InvalidGetStaticPathsEntry, o as GetStaticPathsExpectedParams, q as GetStaticPathsInvalidRouteParam, t as trimSlashes, P as PageNumberParamNotFound, r as NoMatchingStaticPathFound, s as PrerenderDynamicEndpointPathCollide, u as ReservedSlotName, L as LocalsNotAnObject, v as PrerenderClientAddressNotAvailable, C as ClientAddressNotAvailable, S as StaticClientAddressNotAvailable, w as RewriteWithBodyUsed, x as AstroResponseHeadersReassigned, R as ResponseSentError, y as fileExtension, z as slash, p as prependForwardSlash, B as removeTrailingForwardSlash } from './chunks/astro/assets-service_CmwqiMi_.mjs';
import { R as ROUTE_TYPE_HEADER, j as REROUTE_DIRECTIVE_HEADER, k as createSlotValueFromString, r as renderTemplate, d as renderComponent, D as DEFAULT_404_COMPONENT, l as renderSlotToString, n as renderJSX, o as chunkToString, p as isRenderInstruction, q as clientLocalsSymbol, s as clientAddressSymbol$1, t as renderPage, v as REWRITE_DIRECTIVE_HEADER_KEY, w as REWRITE_DIRECTIVE_HEADER_VALUE, x as renderEndpoint, A as ASTRO_VERSION, y as responseSentSymbol, z as REROUTABLE_STATUS_CODES } from './chunks/astro/server_CuaXarcR.mjs';
import 'cookie';
import { A as AstroCookies, s as sequence, d as defineMiddleware, o as onRequest } from './chunks/_astro-internal_middleware_BAuelzLn.mjs';
import 'clsx';
import 'kleur/colors';
import 'fast-glob';
...
const _page2 = () => import('./pages/api/addcurrentfake.astro.mjs');
const _page3 = () => import('./pages/api/booking.astro.mjs');
const _page4 = () => import('./pages/api/calculate.astro.mjs');
const _page5 = () => import('./pages/api/daysopen.astro.mjs');
const _page6 = () => import('./pages/api/getbooking.astro.mjs');
const _page7 = () => import('./pages/api/login.astro.mjs');
const _page8 = () => import('./pages/api/logout.astro.mjs');
const _page9 = () => import('./pages/api/signup.astro.mjs');
const _page10 = () => import('./pages/api/time.astro.mjs');
const _page11 = () => import('./pages/dashboard.astro.mjs');
const _page12 = () => import('./pages/list.astro.mjs');
const _page13 = () => import('./pages/restaurants/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/calculate.ts", _page4],
    ["src/pages/api/daysOpen.ts", _page5],
    ["src/pages/api/getbooking.ts", _page6],
    ["src/pages/api/login.ts", _page7],
    ["src/pages/api/logout.ts", _page8],
    ["src/pages/api/signup.ts", _page9],
    ["src/pages/api/time.ts", _page10],
    ["src/pages/dashboard.astro", _page11],
    ["src/pages/list.astro", _page12],
    ["src/pages/restaurants/[id].astro", _page13],
...
const _args = {
    "middlewareSecret": "e633f760-39f0-472a-ab76-25729927c171",
